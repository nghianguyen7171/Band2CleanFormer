"""
Training script for Band2CleanFormer on EOG-contaminated EEG data.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train Band2CleanFormer for EOG denoising')
    ...
    parser.add_argument('--seq_len', type=int, default=512,
                        help='Sequence length (512 for EOG)')
    ...
    parser.add_argument('--save_path', type=str, default='checkpoints/band2cleanformer_eog.pth',
